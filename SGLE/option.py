...
parser.add_argument('--pretrain_dir', type=str, default="weight/model.pth")
...
### Testing Settings
parser.add_argument('--weight_dir', type=str, help='directory for pretrained weight', default='weight/model.pth')
parser.add_argument('--test_dir', type=str, help='directory for testing output', default='test_output')
parser.add_argument('--input_dir', type=str, help='directory for testing input', default='data/test_data/BDD')
